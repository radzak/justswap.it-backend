    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 3 to 15 characters. Letters and digits.', max_length=30, unique=True, validators=[
                    username_validator], verbose_name='username')),
